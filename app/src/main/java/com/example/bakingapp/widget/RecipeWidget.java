...
public class RecipeWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.recipeswidget);
     ...
     /*   // Set cut corner background for API 23+
        ...
        ingredientSet = GsonInstance.getGsonInstance().fromJson(RecipeRepository.getInstance().getRecipe(modelPosition, context), Receipe.class);
